		...
		<div class="bbp-reply-header">
			...
			<div class="bbp-meta">
				...
				<div class="bbp-forum-title">
					...
					<span class="bbp-forum"><?php _e( 'Forum: ', 'framework' ); ?><a href="<?php bbp_forum_permalink(); ?>"><?php bbp_forum_title(); ?></a></span>

					<?php do_action( 'bbp_theme_after_forum_title' ); ?>

					<span class="bbp-forum-post-date"><?php printf( __( 'Last updated %s', 'framework' ), bbp_get_forum_last_active_time() ); ?> | </span>
