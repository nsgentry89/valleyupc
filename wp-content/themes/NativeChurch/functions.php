...
================================================== */
if ( is_admin() ) {
	include_once NATIVECHURCH_INC_PATH . '/imi-admin/admin.php';
}
...
if ( ! class_exists( 'ReduxFramework' ) ) {
	include_once NATIVECHURCH_INC_PATH . '/imi-admin/theme-options/ReduxCore/framework.php';
}
require_once NATIVECHURCH_INC_PATH . '/imi-admin/theme-options/barebones-config.php';

/* -------------------------------------------------------------------------------------
  THEME INCLUDES
  ----------------------------------------------------------------------------------- */
require_once(NATIVECHURCH_INC_PATH . '/podcasting/podcast-functions.php');
