...
<body <?php body_class($bodyClass); echo ''.$style;  ?>>
	<div class="body header-style<?php echo esc_attr($options['header_layout']); ?>">
		<?php
                  			...
                  			<div class="col-md-4 col-sm-6 col-xs-8">
                           		<h1 class="logo">
                                    ...
                                    if (!empty($imic_options['logo_upload']['url'])) { ?>
                                       <a href="<?php echo esc_url( home_url() ); ?>" class="default-logo" title="<?php echo esc_attr($logoalt); ?>"><img src="<?php echo esc_url($imic_options['logo_upload']['url']); ?>" alt="<?php echo esc_attr($logoalt); ?>"></a>
                                    <?php } else { ?>
                                    ...
                                    if (!empty($imic_options['retina_logo_upload']['url'])) { ?>
                                        <a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr($logoalt); ?>" class="retina-logo"><img src="<?php echo esc_url($imic_options['retina_logo_upload']['url']); ?>" alt="<?php echo esc_attr($logoalt); ?>" width="<?php echo esc_attr($imic_options['retina_logo_width']); ?>" height="<?php echo esc_attr($imic_options['retina_logo_height']); ?>"></a>
                                    <?php } elseif (!empty($imic_options['logo_upload']['url'])) { ?>
                                        <a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr($logoalt); ?>" class="retina-logo"><img src="<?php echo esc_url($imic_options['logo_upload']['url']); ?>" alt="<?php echo esc_attr($logoalt); ?>"></a>
                                   <?php } else { ?>
