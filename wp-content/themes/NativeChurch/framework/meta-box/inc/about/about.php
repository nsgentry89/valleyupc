...
class RWMB_About {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="' . esc_url( $this->get_menu_link() ) . '">' . esc_html__( 'About', 'framework' ) . '</a>';
		return $links;
	}
	...
	public function add_submenu() {
		...
		$about       = add_submenu_page(
			$parent_menu,
			__( 'Welcome to Meta Box', 'framework' ),
	...
	public function change_footer_text() {
		...
		echo wp_kses( sprintf( __( 'Please rate <strong>Meta Box</strong> <a href="%1$s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="%1$s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from the Meta Box team!', 'framework' ), 'https://wordpress.org/support/view/plugin-reviews/meta-box?filter=5#new-post' ), $allowed_html );
	}
