...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <!-- Title & Meta -->
        <title><?php _e('IMIC Framework Shortcodes', 'framework'); ?></title>
        <meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php echo get_option('blog_charset'); ?>" />
        <!-- LOAD scripts -->
        <script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/jquery/jquery.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/framework/shortcodes/shortcodes.js?ver=3.9"></script>
        <?php
        $mywp_version = get_bloginfo('version');
             $js_slug=($mywp_version >= 3.9)?'embed':'embed_3.8'; 
            echo '<script language="javascript" type="text/javascript" src="' . get_template_directory_uri() . '/framework/shortcodes/shortcode.'.$js_slug.'.js?v=1.5.2"></script>';
       ?>
        ...
        <link href="<?php echo get_template_directory_uri() ?>/framework/shortcodes/base.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo get_template_directory_uri() ?>/framework/shortcodes/shortcodes-style.css" rel="stylesheet" type="text/css" />
        <!-- CLOSE head -->
    </head>
    <!-- OPEN body -->
                    ...
                    <fieldset>
                        ...
                        <div class="option">
                            ...
                            <select id="shortcode-select" name="shortcode-select">
                                ...
                                <option value="shortcode-accordion"><?php _e('Accordions', 'framework'); ?></option>
                                <option value="shortcode-buttons"><?php _e('Button', 'framework'); ?></option>
                                <option value="shortcode-columns"><?php _e('Columns', 'framework'); ?></option>
                                <option value="shortcode-counters"><?php _e('Counters', 'framework'); ?></option>
                                <option value="shortcode-form"><?php _e('Form', 'framework'); ?></option>
                                <option value="shortcode-calendar"><?php _e('Calendar', 'framework'); ?></option>
                                <option value="shortcode-icons"><?php _e('Icons', 'framework'); ?></option>
                                <option value="shortcode-imagebanner"><?php _e('Image', 'framework'); ?></option>
                                <option value="shortcode-lists"><?php _e('Lists', 'framework'); ?></option>
                                <option value="shortcode-modal"><?php _e('Modal Box', 'framework'); ?></option>
                                <option value="shortcode-progressbar"><?php _e('Progress Bar', 'framework'); ?></option>
                                <option value="shortcode-staff"><?php _e('Staff', 'framework'); ?></option>
                                <option value="shortcode-sermon"><?php _e('Sermon', 'framework'); ?></option>
                                <option value="shortcode-sidebar"><?php _e('Sidebar', 'framework'); ?></option>
                                <option value="shortcode-event"><?php _e('Latest events', 'framework'); ?></option>
                                <option value="shortcode-tables"><?php _e('Table', 'framework'); ?></option>
                                <option value="shortcode-tooltip"><?php _e('Tooltip', 'framework'); ?></option>
                                <option value="shortcode-typography"><?php _e('Typography', 'framework'); ?></option>
                                <option value="shortcode-tabs"><?php _e('Tabs', 'framework'); ?></option>
                                <option value="shortcode-toggle"><?php _e('Toggles', 'framework'); ?></option>
                                <option value="shortcode-fwvideo"><?php _e('Fullwidth Video', 'framework'); ?></option>
                            </select>
                        </div>
                        <!--//////////////////////////////
                        ////	BUTTONS
