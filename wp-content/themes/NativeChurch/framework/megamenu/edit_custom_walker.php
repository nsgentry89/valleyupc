              ...
              ?>
                ...
                <p class="field-custom description description-wide">
					...
					unset($post_types[$key]);
                            ...
                            echo '<option value ="">' . esc_html__('Select Post Type', 'framework') . '</option>';
                ...
                <p class="field-custom description description-wide">
                    <label for="edit-menu-post-id-comma-<?php echo esc_attr($item_id); ?>">
                        <?php _e('Enter Comma seperated value Ex-1,2,3','framework'); ?><input type="text" id="edit-menu-post-id-comma-<?php echo esc_attr($item_id); ?>" class="menu-post-id-comma edit-menu-item-custom"   name="menu-post-id-comma[<?php echo esc_attr($item_id); ?>]" value="<?php echo ($item->menupostidcomma); ?>" /> 
                    </label>
                </p>
                <p class="field-custom description description-wide">
