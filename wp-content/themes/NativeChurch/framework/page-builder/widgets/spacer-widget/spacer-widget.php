...
class Spacer_Widget extends SiteOrigin_Widget {
	function __construct() {
		...
		parent::__construct(
			'spacer-widget',
			__('Spacer Widget', 'framework'),
			array(
				'description' => __('A widget to add blank spaces in between widgets.', 'framework'),
			...
			array(
				'height' => array(
					'type' => 'text',
					'default'=> '30px',
					'label' => __('Spacer height in pixels. Example: 30px', 'framework'),
				),
			),
