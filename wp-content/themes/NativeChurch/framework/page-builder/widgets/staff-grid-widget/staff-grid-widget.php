...
class Staff_Grid_Widget extends SiteOrigin_Widget {
	function __construct() {
		...
		parent::__construct(
			...
			array(
				'description' => __('A widget to show Staff members in grid view.', 'framework'),
			...
			array(
				...
				'allpostsbtn' => array(
					'type' => 'text',
					'label' => __('All staff button text', 'framework'),
					'default' => __('All Staff', 'framework'),
					'description' => __('This button will be displayed only if the widget has title.', 'framework'),
				),

				'allpostsurl' => array(
					'type' => 'link',
					'label' => __('All staff button URL', 'framework'),
					'description' => __('This button will be displayed only if the widget has title.', 'framework'),
				),
				...
				'orderby' => array(
					'type' => 'select',
					'label' => __('Order by Page ID', 'framework'),
					'state_name' => 'no',
