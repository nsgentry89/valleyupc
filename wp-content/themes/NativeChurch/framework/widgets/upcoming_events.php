...
class upcoming_events extends WP_Widget {
	...
	public function __construct() {
		 $widget_ops = array('description' => __( "Display Upcoming Events.", 'framework') );
         parent::__construct(false, $name = __('Upcoming Events','framework'), $widget_ops);
	}
	...
	?>
        ...
        <p>
	            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php _e('Number of events to show', 'framework'); ?></label>
