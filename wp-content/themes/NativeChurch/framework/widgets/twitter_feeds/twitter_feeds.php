...
class twitter_feeds extends WP_Widget {
	...
	public function __construct() {
		 $widget_ops = array('description' => __( "Show latest twitter feeds.", 'framework') );
         parent::__construct(false, $name = __('Twitter Feeds','framework'), $widget_ops);
	}
	...
	?>
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('username')); ?>"><?php _e('Twitter Username', 'framework'); ?></label>
        	<input class="widefat" id="<?php echo esc_attr($this->get_field_id('username')); ?>" name="<?php echo esc_attr($this->get_field_name('username')); ?>" type="text" value="<?php echo esc_attr($username); ?>" />
        </p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php _e('Number of Feeds', 'framework'); ?></label>
        	<input class="widefat" id="<?php echo esc_attr($this->get_field_id('count')); ?>" name="<?php echo esc_attr($this->get_field_name('count')); ?>" type="text" value="<?php echo esc_attr($count); ?>" />
        </p>
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('consumerKey')); ?>"><?php _e('Consumer Key', 'framework'); ?></label>
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('consumerKeySecret')); ?>"><?php _e('Consumer Key Secret', 'framework'); ?></label>
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('accessToken')); ?>"><?php _e('Access Token', 'framework'); ?></label>
        ...
        <p>
        	<label for="<?php echo esc_attr($this->get_field_id('accessTokenSecret')); ?>"><?php _e('Access Token Secret', 'framework'); ?></label>
			...
			if(count($result)>0){
				foreach($result as $feed){
					echo '<li><i class="fa fa-twitter"></i> '.$feed['text'].' <span class="date">'.$feed['timestamp'].'</span></li>';	
                            ...
                            echo '<li>'.__( "Loading ...", 'framework').'</li>';
				}	
		}else{
			echo '<li>'.__( "Loading ...", 'framework').'</li>';
		}
